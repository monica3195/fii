...
import mainApp.Main;
import modul5.esaWikipedia.CircleLayoutFrame;
...
public class GUI {
	 ...
	 * @param window 
	 */
	public static void modul5(Main win) {
	...
	private void initialize() {
		...
		frmEsawiki.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		try {
			UIManager
		...
		JLabel textLabel2 = new JLabel("NB. CONCEPTS ");
		...
		frmEsawiki.addWindowListener(new WindowAdapter() {
			@Override
