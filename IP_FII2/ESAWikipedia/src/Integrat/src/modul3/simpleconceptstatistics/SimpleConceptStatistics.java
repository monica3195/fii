...
public class SimpleConceptStatistics {
	...
	public static File pageIndex = new File(System.getProperty("user.dir")+sep+"indexFaraStopWords.txt");
	...
	public void run(){
        ...
        File f = new File(System.getProperty("user.dir")+sep+"lemmaProcessingOutput");
		if(f.isDirectory()){
