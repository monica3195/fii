...
public class FrecvCuvinte implements Statistica {
    ...
    public String getResult() {
        ...
        for (Entry<String, Integer> entry : sortat.entrySet()){
			rezultat=rezultat+PROIECTIP.index.get(entry.getKey())+" "+entry.getValue()+" "+ entry.getKey()+System.getProperty("line.separator"); // asta ca sami afiseze si numele conceptului
			//rezultat=rezultat+PROIECTIP.index.get(entry.getKey())+" "+entry.getValue()+System.getProperty("line.separator");
        }
		return rezultat;
    }
}
