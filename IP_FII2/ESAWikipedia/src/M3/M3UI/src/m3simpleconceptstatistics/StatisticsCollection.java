...
public class StatisticsCollection {
	...
	public StatisticsCollection() {
		...
		outputFile = new File(System.getProperty("user.dir")+ sep +"M3"+sep+ "simpleConceptStatisticsOutput");
		if(!outputFile.exists()){
			outputFile.mkdir();
		}
		outputFileRest = new File(System.getProperty("user.dir")+ sep + "M3" + sep + "outputRest");
