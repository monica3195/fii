...
void Display8() {
    ...
    float rightUpperX = 0.3;
    float rightUpperY = 0.5;
    float rightMiddleY = 0.6;
    float scaleForRed = 0.75;
    float scaleForWhite = 0.73;


    glColor3f(0.2,0.15,0.88); // albastru
    glBegin(GL_POLYGON);
    glVertex2f(rightUpperX, rightUpperY);
    glVertex2f(rightMiddleY, 0);
    glVertex2f(rightUpperX, -rightUpperY);
    glVertex2f(-rightUpperX, -rightUpperY);
    glVertex2f(-rightMiddleY, 0);
    glVertex2f(-rightUpperX, rightUpperY);
    ...
    glColor3f(1,0.1,0.1); // rosu
    glBegin(GL_POLYGON);
    glVertex2f(rightUpperX * scaleForRed, rightUpperY * scaleForRed);
    glVertex2f(rightMiddleY * scaleForRed, 0);
    glVertex2f(rightUpperX * scaleForRed, -rightUpperY * scaleForRed);
    glVertex2f(-rightUpperX * scaleForRed, -rightUpperY * scaleForRed);
    glVertex2f(-rightMiddleY * scaleForRed, 0);
    glVertex2f(-rightUpperX * scaleForRed, rightUpperY * scaleForRed);
    ...
    glColor3f(1,1,1); //alb
    glBegin(GL_POLYGON);
    glVertex2f(rightUpperX * scaleForWhite, rightUpperY * scaleForWhite);
    glVertex2f(rightMiddleY * scaleForWhite, 0);
    glVertex2f(rightUpperX * scaleForWhite, -rightUpperY * scaleForWhite);
    glVertex2f(-rightUpperX * scaleForWhite, -rightUpperY * scaleForWhite);
    glVertex2f(-rightMiddleY * scaleForWhite, 0);
    glVertex2f(-rightUpperX * scaleForWhite, rightUpperY * scaleForWhite);
