...
double scalarProd(const SparseMatrix &A, const SparseMatrix &B) {
	double rez=0;
...
int main(void) {
	...
	ifstream fin("MatriceA6.txt");
	
	int n=500;
	SparseMatrix A(fin,0);
	...
	if (k==kmax+1) cout<<"fail to aproximate proper value\n";
	else cout<<setprecision(10)<<fixed<<prop_value<<"\n";
